    ...
    internal sealed class Configuration : DbMigrationsConfiguration<WebBanHangOnline.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(WebBanHangOnline.Models.ApplicationDbContext context)
        {
            ...
            context.ProductCategories.AddOrUpdate(x => x.Id,
                new ProductCategory() { Id = 1, Title = "Cà phê", Description = "Cà phê hạt", Icon="", CreateBy="Duy", CreateDate=DateTime.Parse("01-01-2023"), ModifierBy="", ModifierDate=DateTime.Now },
